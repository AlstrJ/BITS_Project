package dev.alastairjordan.moogloommod.client.model;
...
public class MoogloomModel<T extends Entity> extends QuadrupedModel<T> {
    public MoogloomModel(ModelPart p_170515_) {
        super(p_170515_, false, 10.0F, 4.0F, 2.0F, 2.0F, 24);
    }

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(MoogloomMod.MODID, "moogloom"), "main");
